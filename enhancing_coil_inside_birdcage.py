...
# plt.savefig(utils.this_path+f"Birdcage_motion/both_coils/birdcage_w_enh.png", dpi=300)
plt.close("all")
...
utils.show_field_magn(grid_slice=grid, coil=figured_coil, ax=ax2, fig=fig2, vmax=80)
ax2.set_xlabel("x (mm)")
ax2.set_ylabel("y (mm)")
...
# plt.savefig(f"birdcage_fieldmagn_part{partnum}_80", dpi=300)
# plt.close("all")
